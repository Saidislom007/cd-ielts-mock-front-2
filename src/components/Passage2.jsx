...
const Passage2 = ({ onSubmit }) => {
  ...
  useEffect(() => {
    axios
      .get("/api/reading-tests/2/passage/2")
      .then((res) => {
        setPassage(res.data);
        setLoading(false);
      })
  ...
  const handleAnswerChange = (questionId, value) => {
    ...
    if (passage && onSubmit) {
      ...
      passage.questions.forEach((q) => {
        const userAnswer = updatedAnswers[q.id]?.toString().trim().toLowerCase();
